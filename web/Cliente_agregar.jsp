    ...
    <body>
        ...
        <div class="formulario" style="text-align: center;">
            <form  action="Controlador?menu=Cliente" method="POST">
                ...
                <div class="form-group">
                    <input type="text"  name="txtNombres" placeholder="Nombre"class="form-control">
                </div>
                
                <div class="form-group">
                    <input type="text" name="txtApellidos" placeholder="Apellido" class="form-control">
                </div>
                
                <div class="form-group">
                    <input type="text"  name="txtDir" placeholder="Direccion"class="form-control">
                </div>
